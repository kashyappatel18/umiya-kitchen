jQuery(document).ready(function(){
   ...
   { value: 'Zimbabwe', data: 'ZZ' }
       ...
       /* jQuery("#trans_details").typeahead({
            hint:true,
            highlight:true,
            scroll:true,
       ...
       /*jQuery("#trans_details").keyup(function(){
            jQuery.ajax({
                url:base_url+'sinvoice/transSearch',
    ...
    jQuery('.product').change(function(){
            ...
            if(prod_id!=""){
                jQuery.ajax({
                    ...
                    type:'POST',
                    data:'prod_id='+prod_id+"&cust_id="+cust_id+"&inv_type=0",
                    success:function(data){
                ...
                jQuery.ajax({
                    ...
                    success:function(data){
                        jQuery(objpd).parent().parent().find('.qtydisp').html(data);
                        //alert(cust_id);
                    }
                });
            }
...
function calc(){
	...
	jQuery('.remove').click(function(){
        ...
        jQuery('#tax_id').change(function(){
            ...
            jQuery.ajax({
                url:base_url+'Sinvoice/nextInvNo',
                type:'POST',
                data:'tax_id='+id,
                success:function(data){
                    jQuery('#inv_no').val(data);
                }
            });
        });
