...
<div class="container">
    <table>
        <tr>
            ...
            <td width="40%" align="center">Credit Note</td>
	...
	<table border="1">
					...
					<?php
						...
						while ($count<25) : // this while loop displyas blank rows
							$count++;						
					?>
					<tr class="details"><td class="details">&nbsp;</td><td class="details">&nbsp;</td><td class="details">&nbsp;</td><td class="details">&nbsp;</td><td class="details">&nbsp;</td><td class="details">&nbsp;</td><td class="details">&nbsp;</td></tr>					
					<?php
