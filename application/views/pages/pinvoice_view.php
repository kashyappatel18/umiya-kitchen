...
<?php echo form_open('pinvoice/insert'); ?>
	<div class="row">
		<div class="form-group col-lg-4">
			...
			<input class="form-control" id="inv_no" name="inv_no" value="<?php echo set_value('inv_no'); ?>">
		</div>
		<div class="form-group col-lg-2">
			<label>Date</label>
                ...
                <div class="form-group col-2">
                    ...
                    <input class="form-control" name="due_date" type="date" value="<?php echo set_value('due_date');?>">
                </div>
		<div class="form-group col-lg-2">
